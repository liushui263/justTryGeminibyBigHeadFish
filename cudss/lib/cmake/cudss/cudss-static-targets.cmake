...
foreach(_cmake_expected_target IN ITEMS cudss_static)
...
# Create imported target cudss_static
add_library(cudss_static STATIC IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/cudss-static-targets-*.cmake")
